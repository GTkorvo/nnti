...
\SANDnum{SAND2005-XXXX} \SANDauthor{ Marzio Sala, William F. Spotz,
Eric T. Phipps, Michael A. Heroux}
...
\note{What is the difference between SciPy and ScientificPython?}
\end{itemize}
