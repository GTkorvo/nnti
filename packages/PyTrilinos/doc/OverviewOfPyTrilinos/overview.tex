...
is reported in Section~\ref{sec:organization}. Comments on the usage of
...
and PyTrilinos codes are reported in Section~\ref{sec:using}.
Section~\ref{sec:comparison} positions PyTrilinos with respect to similar
projects. COncluding remarks are reported in Section~\ref{sec:concluding}.

\note{Talk about ``fine-grained'' scripts and ``coarse-grained'' scripts, the
  latter being suitable for PyTrilinos}
