...
\item {\bf Amesos} contains a set of clear and consistent interfaces
  ...
  TAUCS~\cite{taucs-home-page}, SuperLU and
  ...
  We refer to the Amesos reference guide~\cite{Amesos-Reference-Guide}
  for more details.
...
support. Because of this, several projects entered the scene, to fill
the gap between Python and MPI applications. We have analyzed the
following:
...
projects defines a well-recognized standard, since they are still
