...
public class MatrixVectorWriter extends PrintWriter {
	 ...
	 * array specifies the real entries, and the second is the imaginary
	 * entries
	 */
	 ...
	 * entry on each line. The offset is added to the index, typically, this
	...
	/**
	 * Prints the coordinate format to the underlying stream. One index pair
	 * and entry on each line. The offset is added to each index, typically,
	 ...
	 * can transform from a 0-based indicing to a 1-based. The first float
	 * array specifies the real entries, and the second is the imaginary
	 * entries
	 */
	public void printCoordinate(
	 ...
	 * Prints the coordinate format to the underlying stream. One index pair
	 * and entry on each line. The offset is added to each index, typically,
	 * this can transform from a 0-based indicing to a 1-based. The first float
	 * array specifies the real entries, and the second is the imaginary
	 * entries
	 */
	public void printCoordinate(
	 ...
	 * Prints the coordinate format to the underlying stream. One index pair
	 * and entry on each line. The offset is added to each index, typically,
	 * this can transform from a 0-based indicing to a 1-based. The first
	 * double array specifies the real entries, and the second is the imaginary
	 * entries
	 */
	public void printCoordinate(
		int[] row,
	...
	/**
	 * Prints the coordinate format to the underlying stream. One index pair
	 * and entry on each line. The first double array specifies the real
	 * entries, and the second is the imaginary entries
	 */
	public void printCoordinate(
		int[] row,
		int[] column,
