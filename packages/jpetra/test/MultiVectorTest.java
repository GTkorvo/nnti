...
class MultiVectorTest {
	...
	aMap.getMyGlobalElements(aGlobalElements);
	int [] bGlobalElements = new int [bRows];
	aMap.getMyGlobalElements(bGlobalElements);
    ...
    public static int buildMatrixTests(Jpetra.MultiVector c, String transa, String transb, double alpha,
        ...
        */
        ...
        aMap.getMyGlobalElements(aGlobalElements);
        int [] bGlobalElements = new int [bRows];
        bMap.getMyGlobalElements(bGlobalElements);
    ...
    public static void check (int ierr, String point) {
        if (ierr != 0) {
            System.err.println("Failed at point " + point + " with error code "+ ierr);
            System.exit(1);
        }
    }
}
