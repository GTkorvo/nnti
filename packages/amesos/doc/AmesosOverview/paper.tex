...
here; instead
steps (S0/1), (S2) and (S3)  can be standardized by
adding an intermediate layer between the application and the
direct solver libraries. This layer will be defined in terms of an abstract framework, that
...
\item \verb!bool IsSymmetric()! returns {\tt true} if only the upper
...
M.~Sala, and K.~Stanley, is distributed within the
