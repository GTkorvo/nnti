...
extern "C" {
  ...
  void iMesh_getDescription(iMesh_Instance instance,
                            /*inout*/ char *descr, 
                            int *err, 
                            /*in*/ int descr_len) {*err = iBase_NOT_SUPPORTED;}
  ...
  void iMesh_newMesh(const char *options,
                     ...
                     /*out*/ int *err, 
                     /*in*/ int options_len) {*err = iBase_NOT_SUPPORTED;}
 ...
 */
  ...
  void iMesh_createTag(iMesh_Instance instance,
                       ...
                       /*out*/ int *err,
                       /*in*/ const int tag_name_len) {*err = iBase_NOT_SUPPORTED;}
  ...
  void iMesh_getTagName(iMesh_Instance instance,
                        ...
                        /*inout*/ char *name,
                        /*out*/ int *err,
                        /*in*/ int name_len) {*err = iBase_NOT_SUPPORTED;}
