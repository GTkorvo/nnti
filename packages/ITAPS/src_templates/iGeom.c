...
extern "C" {
  ...
  void iGeom_getDescription( iGeom_Instance instance,
                             char* descr,
                             int* err,
                             int descr_len ) {*err = iBase_NOT_SUPPORTED;}
  ...
  void iGeom_getErrorType(iGeom_Instance instance,
                          /*out*/ int *error_type, 
                          int *err) {*err = iBase_NOT_SUPPORTED;}
  ...
  void iGeom_newGeom( char const* options,
                      ...
                      int* err,
                      int options_len ) {*err = iBase_NOT_SUPPORTED;}
     ...
     * \param *err Pointer to error type returned from function
     */
  void iGeom_dtor( iGeom_Instance instance, int* err ) {*err = iBase_NOT_SUPPORTED;}
 ...
 */
  void iGeom_getFaceType( iGeom_Instance instance,
                          ...
                          char* face_type,
                          int* err,
                          int* face_type_length) {*err = iBase_NOT_SUPPORTED;}
 ...
 */
  ...
  void iGeom_getNextEntArrIter( iGeom_Instance instance,
                                iGeom_EntityArrIterator iterator,
                                iBase_EntityHandle** entity_handles,
                                int* entity_handles_allocated,
                                int* entity_handles_size,
                                int* has_data,
 ...
 */
   ...
   */
  void iGeom_deleteAll( iGeom_Instance instance, int* err ) {*err = iBase_NOT_SUPPORTED;}
 ...
 */
  ...
  void iGeom_isEntArrContained( iGeom_Instance instance,
                      ...
                      /*inout*/ int* is_contained_allocated,
                        ...
                        /*out*/ int* err ) {*err = iBase_NOT_SUPPORTED;}
  ...
  void iGeom_createTag(iGeom_Instance instance,
                       ...
                       int *err,
                       int tag_name_len ) {*err = iBase_NOT_SUPPORTED;}
  ...
  void iGeom_getTagName(iGeom_Instance instance,
                        ...
                        char *name, 
                        int* err,
                        int name_len) {*err = iBase_NOT_SUPPORTED;}
  ...
  void iGeom_getDblData(iGeom_Instance instance,
                        ...
                        double *out_data, int *err) {*err = iBase_NOT_SUPPORTED;}
