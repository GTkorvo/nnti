...
extern "C" 
{
    ...
    */
  void iRel_dtor(iRel_Instance instance, int *ierr) {*ierr = iBase_NOT_SUPPORTED; }
  ...
  void iRel_createAssociation (
    ...
    int *ierr) {*ierr = iBase_NOT_SUPPORTED; }
  ...
  void iRel_newAssoc(const char *options,
                     iRel_Instance *instance,
                     int *ierr,
                     const int options_len) {*ierr = iBase_NOT_SUPPORTED; }
