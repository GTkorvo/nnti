...
Section~\ref{sec:benchmarking} provides some timings comparing ARPACK and Anasazi to 
demonstrate that object-oriented overhead has no impact on the performance of this
...
\begin{itemize}
  ...
  \item operator-multivector applications: $\mathbf{A} \mathbf{U}$;
  \item multivector arithmetic: $\mathbf{V}^H (\mathbf{A}\mathbf{U})$;
...
The decisions involved in Steps~2 and 4 require the determination of the intersting portion of the
