...
\verbatiminput{code/paunchy_serial_build}

The Trilinos MPI build was configured as follows:
\verbatiminput{code/paunchy_mpi_build}
...
The Trilinos serial build was configured as follows:
\verbatiminput{code/sophie_serial_build}

The Trilinos MPI build was configured as follows:
\verbatiminput{code/sophie_mpi_build}
...
The Trilinos MPI build was configured as follows:
\verbatiminput{code/qed_mpi_build}
