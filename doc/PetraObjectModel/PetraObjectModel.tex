...
\begin{table}
  ...
  \begin{tabular}{|p{0.8in}||p{1.5in}|p{1.5in}|p{1.5in}|}
    ...
    giving great flexibility in how the operations can be optimally performed.  Furthermore the
    Distributor is a static record of data-dependent communications that can be reused many times.
    & Since all of these classes are abstract, we can provide multiple impementations, including MPI and serial, without
