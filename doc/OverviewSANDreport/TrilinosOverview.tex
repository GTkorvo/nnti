...
providing the reader with an summary of the project in its current state.  
    ...
    The
    algebraic methods are based primarily on the ideas of smoothed aggregation.
    The methods in ML can be used either as linear solvers or as preconditioners
    to an outer iterative method.
...
The smoother is a specialized distributed relaxation method \cite{}.
...
More information is available in either the ML User's manual \cite{} and at
 the ML website~\cite{ML-home-page}.
