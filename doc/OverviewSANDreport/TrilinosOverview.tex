...
Although it is not always clear which data and methods should belong in a given class, we
...
constructed explicitly either.  All four of these class types become usable when a concrete class
