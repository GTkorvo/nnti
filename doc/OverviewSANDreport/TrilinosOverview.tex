...
The Amesos package is markedly different than other Trilinos
...
vectors to be passed to each third-party solver.  At this time, we
provide support for SuperLU (serial), SuperLUDist~\cite{SuperLU}, 
Kundert's Sparse solver (from
Spice~\cite{spice}),DSCPack~\cite{dscpack}, UMFPack~\cite{umfpack}
and MUMPS~\cite{mumps}.
