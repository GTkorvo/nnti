...
\subsection{Mechanism 3: Package Builds Under Trilinos {\tt configure} Scripts}
...
\subsection{Mechanism 4: Package Can Use Epetra Internally}
...
software engineering where data and
procedures (called methods) that are logically related are kept together in a class.  
...
are norms, dot products and vector updates.  Vector can also be used with a linear operator,
