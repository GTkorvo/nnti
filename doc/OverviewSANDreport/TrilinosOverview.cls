...
%%-------------------------------------------------------------------------
%% Purpose        : LaTeX class (.cls) file for general Trilinos documents.
...
\ProvidesPackage{TrilinosOverview}[\SANDreportVersion]
\ProvidesFile{TrilinosOverview.cls}[\SANDreportVersion]
...
\newcommand{\SANDdistInternal}[4]{
  \ifthenelse{\boolean{SANDdistributionProvided}}   {
    ...
    \ClassError{TrilinosOverview.cls}{\@backslashchar SANDdistribution
...
\lhead[\fancyplain{}{\TrilinosTM{} Overview }]%
{\fancyplain{}{\rightmark}}
\rhead[\fancyplain{}{\leftmark}]
{\fancyplain{}{\TrilinosTM{} Overview}}
