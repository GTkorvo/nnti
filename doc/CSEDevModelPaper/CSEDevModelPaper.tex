...
potential, all of the components need to work together in
...
autonomy.  While most packages never stray far from the
...
the means to communicate with other packages to coordinate and create records 
...
``process improvement'' is the incremental improvement of the processes by
which that software is developed.  
...
have been presented.  Next, we will discuss how to meet 
...
The release process has benefited greatly from process improvement.  The 
initial timeline and process checklists were created based on the what worked
fairly well in the past.  By guaranteeing that important steps would be 
