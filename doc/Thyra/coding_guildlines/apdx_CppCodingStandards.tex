...
{}\textbf{Organizational and Policy Issues}
  ...
  [\textbf{Ammended}, see Appendix {}\ref{sec:arguments-for-consistent-style}
  and Section {}\ref{thyracodingguidelines:formatting:sec}]
...
{}\textbf{Class Design and Inheritance}
...
{}\textbf{Construction, Destruction, and Copying}
...
{}\textbf{Templates and Genericity}
...
{}\textbf{Error Handling and Exceptions}
