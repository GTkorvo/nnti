...
\begin{abstract}
%
Coding guidelines help to improve the quality of code and facilitate
collaborative development.  This document covers C++ code, code
formatting, and Doxygen documentation guildelines that have been
established for the Trilinos Thyra package and related C++ codes.
Many of these guidelines are followed in other Trilinos packages as
well.  While the guidelines outlined in this document are related to
Thyra C++ code, most of the guidelines are more general that Thyra and
even Trilinos.
%
\end{abstract}
%
