...
C++ coding, code formatting, and Doxygen documentation guidelines
that have been established for the Trilinos package Thyra.  Many of
these guidelines are followed in other Trilinos packages as well.
While some of the guidelines outlined in this document are more
specifically targeted to Thyra, most of the guidelines are more
general that Thyra or even Trilinos.
%
\end{abstract}
%
