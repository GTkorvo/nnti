...
{}\arabic{Thyra_NC_counter}}: {}\textit{C++ enum type names should begin with
{}\texttt{E} as {}\texttt{EMyEnum} and capitalize and scope enum values as
{}\texttt{MY\_ENUM\_VALUE}}}
...
(i.e., due to interfacing with non-complient code), minimize the amount of
...
smart ponter types (e.g., {}\texttt{RCP}, {}\texttt{Ptr}, etc.)}}
