...
persons vary from open source projects (i.e.\ GNU) to newer Agile methods
(e.g.\ Extreme Programming) to large software companies like Microsoft.  As
...
A few points are with making before looking at opinions on formatting style
