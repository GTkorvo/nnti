...
{}\item\stepcounter{Thyra_GCG_counter}\textbf{GCG \arabic{Thyra_GCG_counter}}:
{}\textit{Use Teuchos::ArrayRCP for memory management of
...
{}\texttt{std::\-vector}.  A {}\texttt{Teuchos::ArrayRCP} object can
...
{}\texttt{Teuchos\-::Array\-RCP} and others to build a fully
