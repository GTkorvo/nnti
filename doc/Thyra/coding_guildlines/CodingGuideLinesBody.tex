...
ambugous function calls that will not happen when using raw C++ pointers or
references.

{}\textit{Justification}: Cconsider the following overloaded funcitons:
...
With non-overloaded functions, the following code fragement compiles just
fine:
...
these can be treaded as output objects in their own right.  For example,
...
To tell for sure, one would have to look at the function proptoype:
