...
higher quality using Agile/Emergent\todo[inline]{Citation for Agile/Emergent?} 
...
{}\textbf{SS} (Secondary Stable) tested code has dependencies on more than
just the minimal set of TPLs (such as depending on Boost) or is
code that does not represent critical functionality such that if
broken would significantly hamper the work of other developers.
...
{}\item Generally does {}\underline{not} have high-quality
...
{}\item\textit{Exceptionally well tested}: The current functionality
...
the resulting software loses consistent
structure.  The tendency for software to lose its internal structure under subsequent releases and
...
development versions between releases\todo[inline]{We don't use this process with Z?}.  This release number X.Y.Z is
given in integer form in macros in the configured header file
{}\ttt{<PROJECT>\_version.h} (e.g.\ {}\ttt{Trilinos\_version.h}).
