...
\markboth{Michael Heroux et al.}{An Overview of Trilinos}
...
\keywords{Object-Orientation, Vectors, Interfaces, ...}
...
Section~\cite{sect:meros} presents the Meros package in greater detail
