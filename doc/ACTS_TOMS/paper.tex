...
\category{G.1.3}{Numerical Analsys}{Numerical Linear Algebra--sparse
and very large systems}
\category{G.4}{Mathematics of Computing}{Mathematical Software}
\category{D.1.5}{Programming Techniqes}{Object-Oriented Programming}

\terms{Algorithms, Design, Performance}

\keywords{Software Engineering, Interfaces}
