...
& = & 0, \; \bar{t} \in \left[0, t_f-t_0 \right],
...
\end{eqnarray}
%
where $\breve{\Lambda}=\Lambda$ and $\slantedfrac{d}{d\bar{t}} (\breve{\Lambda}) =
-\slantedfrac{d}{dt}(\Lambda)$.
...
\end{equation}
%
consisting of the columns $\breve{\lambda}_{j}$ of $\breve{\lambda}$ and then defining the
...
{}\textbf{TODO: This section needs to be updated in terms of reverse time to
will lead to a direct implementation in code.}
