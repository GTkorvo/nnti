...
discovers some strange behavor from a numerical solver.  The algorithm
...
Oni interesting output of this work was the behavior of the optimization
...
simulation of the bipolor junction transistor subject to radiation damage
...
sensitivities using first-order finite-differencing to the instrusive method
in Rythmos and found  several dramatic advantanges of the Rythmos approach.
...
inaccurate and not suitable for gradient-based optimization.  Finally the
...
to even compare performance of these different optimization approches.
