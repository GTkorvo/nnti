...
% rabartl: Okay, I can think of a few examples that have come up ...
...
methods. [ToDo: rabartl: We have not really compared to the non-invasive
...
forward simulation problems for the QASPR 2n2222 semiconductor model on ??? 
processors demonstrating X, Y, and/or Z [ToDo: tscoffe or etphipps or rjhoeks:
a) Expand the description of this problem, b) create some placeholder for
results in lue of results, c) Actually get the results and fill in what this
demonstrates!].
...
parameters [ToDo: rjhoeks: Please add some detail about the nature of these
...
block-box finite-difference methods [ToDo: rabartl: We don't have these
results yet but this is my number one technical goal leading up to the end of
the milestone].
...
We solved a ??? problem for the ???  model on ??? processors demonstrating ??? 
[ToDo: rppawlow: a) fill in the description of this problem, b) add a
placeholder for the final result, c) add the final results and the discussion
of those results when we have them].
