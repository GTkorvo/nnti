...
preconditioner and linear solver capabilities in Trilinos.  Let $N$ be the number
of nonlinear algorithms and $M$ be the number of applications that one wishes
