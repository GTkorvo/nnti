...
{}\textbf{ToDo:} Set up the proper reusable macros to standardize the
usage of timers on a package-by-package basis and then document here!
...
\item The header file \ttt{SomeClass.hpp} is designed to be included
  ...
  \ttt{SomeClass\_def.hpp} or CMake will recompile client code whe
  \ttt{SomeClass\_def.hpp} changes.  See examples of how to
  autogenerate \ttt{SomeClass.hpp} by looking at the Thyra package.
