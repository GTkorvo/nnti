...
unchanged.\footnote{While changing the name of a class, function or
  ...
  conventions do not affect the meaning of the program and are
...
largely be automated.\footnote{Popular text editors, such as Emacs and
  Vim (a derivative of the \texttt{vi} text editor), support multiple
  file-specific formatting styles for C++.  Tools like Artistic Style
  {}\cite{ArtisticStyle} can format source files from the command
  line.} This allows individual developers to work with any style they
would like for files that they create, and also makes it easier for
...
by Emacs when using the custom style ``thyra'' defined in the Emacs
package file \texttt{cc-thyra-styles.el}.\footnote{See
